...
<head>
  ...
  <style>
    ...
    .spinner {{
      width: 52px; height: 52px; border: 4px solid rgba(74, 111, 165, 0.25);
      border-top-color: #4a6fa5; border-right-color: #00E5FF; border-radius: 50%;
      animation: spin 0.85s linear infinite; margin: 0 auto 1rem;
